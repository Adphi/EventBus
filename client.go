...
// func (client *Client) doSubscribe(fn interface{}, serverAddr, serverPath string, subscribeType SubscribeType) error {
// 	defer func() {
// 		if r := recover(); r != nil {
...
// 	}
// 	if *reply {
// 		client.eventBus.Subscribe(fn)
// 	}
// }
//
// // Subscribe subscribes to a topic in a remote event bus
// func (client *Client) Subscribe(fn interface{}, serverAddr, serverPath string) error {
// 	return client.doSubscribe(fn, serverAddr, serverPath, Subscribe)
// }
//
// // SubscribeOnce subscribes once to a topic in a remote event bus
// func (client *Client) SubscribeOnce(fn interface{}, serverAddr, serverPath string) error {
// 	return client.doSubscribe(fn, serverAddr, serverPath, SubscribeOnce)
// }
//
...
// func (service *ClientService) PushEvent(e Event, reply *bool) error {
// 	err := service.client.eventBus.Publish(e)
// 	*reply = true
// 	return err
// }
